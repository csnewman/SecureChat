...
public class LoginWindow extends JFrame implements ILoginGui {
	...
	private void connect(ActionEvent event) {
		...
		// connectingDialog.setStatus("Connecting to " + info.getServerIp() +
		// ":" + info.getServerPort() + "...");
		//
		// Consumer<String> disconnectHandler = r -> {
		// JOptionPane.showMessageDialog(connectingDialog, "Reason: " + r + "
		// when " + connectingTask + ".",
		...
		// networkClient.connect(info.getServerIp(), info.getServerPort(),
		// info.getPublicKey(),
		...
		// JOptionPane.showMessageDialog(connectingDialog, "Connected!",
		...
		// networkClient.setSingleHandler(ConnectedPacket.class,
		// responseHandler);
		// networkClient.sendPacket(new
		// ChallengeResponsePacket(c.getTempCode()));
		// };
		//
		// connectingDialog.setStatus("Logging in...");
		// connectingTask = "logging in";
		// networkClient.setSingleHandler(ChallengePacket.class,
		// challengeHandler);
		// networkClient.sendPacket(new ConnectPacket(info.getUsername(),
		// info.getCode()));
		// });
